...
export const levelMetadata = pgTable("level_metadata", {
	id: integer().primaryKey().generatedAlwaysAsIdentity({ name: "level_metadata_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	idLevel: integer("id_level").notNull(),
...
export const levelPoints = pgTable("level_points", {
	...
	index("IX_level_points_level").using("btree", table.idLevel.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.idLevel],
			foreignColumns: [level.id],
...
export const personalBestGlobal = pgTable("personal_best_global", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "personal_bests_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
...
export const record = pgTable("record", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "records_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	idUser: integer("id_user").notNull(),
	time: real().notNull(),
	...
	index("IX_records_level_time").using("btree", table.idLevel.asc().nullsLast().op("int4_ops"), table.time.asc().nullsLast().op("int4_ops")),
...
export const recordMedia = pgTable("record_media", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "media_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	idRecord: integer("id_record").notNull(),
...
export const vote = pgTable("vote", {
	id: integer().primaryKey().generatedAlwaysAsIdentity({ name: "vote_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	idUser: integer("id_user").notNull(),
	idLevel: integer("id_level").notNull(),
...
export const worldRecordGlobal = pgTable("world_record_global", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "world_records_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	idRecord: integer("id_record").notNull(),
	idLevel: integer("id_level").notNull(),
	dateCreated: timestamp("date_created", { withTimezone: true, mode: 'string' }).notNull(),
	dateUpdated: timestamp("date_updated", { withTimezone: true, mode: 'string' }),
